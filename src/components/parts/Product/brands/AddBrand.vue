                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12 mt-4">
                        <div class="mb-3">
                          ...
                          <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="Short Description"></textarea>
                        </div>
                      </div>
                    </div>
                    <div
                      ...
                      <div class="d-flex gap-3 align-items-center btns">
                        <router-link :to="{name:'brands'}" data-bs-dismiss="modal">
